...
template <> constexpr inline auto ChatMessageModel::qt_create_metaobjectdata<qt_meta_tag_ZN16ChatMessageModelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'markMessageAsRead'
        QtMocHelpers::SlotData<void(const QModelIndex &)>(25, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 26, 27 },
        }}),
    };
...
void ChatMessageModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 10: _t->markMessageAsRead((*reinterpret_cast<std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        default: ;
        }
    }
